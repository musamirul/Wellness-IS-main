...
<html>
    ...
    <body>
        ...
        <?php
            ...
            $query1 = "SELECT * FROM patient WHERE mrn = '1234'";
            ...
            <?php
                $query3 = "INSERT INTO record(mrn, smokerUsed,asthmaUsed, diabetesUsed, heart_diseaseUsed, hypertensionUsed, strokeUsed, cancerUsed, tuberculosisUsed, 
                skin_diseaseUsed, kidneypUsed, fits_psychiatricUsed, fatherUsed, motherUsed, siblingsUsed, habitsUsed, allergyUsed, othersUsed, medicationUsed, historyDate, 
                appearanceUsed, weightUsed, heightUsed, bmiUsed, systolicUsed, diastolicUsed, pulseUsed, va_aidedrUsed, va_aidedlUsed, va_unaidedrUsed, va_unaidedlUsed, 
                colour_rUsed, colour_lUsed, fundoscopy_rUsed, fundoscopy_lUsed, nose, throat, neck, skin, excanal_r, excanal_l, eardrum_r, eardrum_l, discharged_r, 
                discharged_l, sound, murmur, airentry, chestexp, breathsound, liver, spleen, kidney, mentalfunct, coordination, gait, genitalia, rectal, lpow_r, lpow_l, 
                lref_r, lref_l, lsen_r, lsen_l, upow_r, upow_l, uref_r, uref_l, usen_r, usen_l, breast, lmp, gynaecology, lastps, cxr, ecg, mammogram, us_breast, 
                us_abdopel, stresstest, pta, lft, urine, blood, impression, recommendation, lastUpdate, doneBy, visits, packageUsed, addonsUsed, fk_patient_ic) 
                VALUES ('$mrn','$smoker','$asthma','$diabetes','$heart_disease','$hypertension','$stroke','$cancer','$tb','$skin_disease','$kidneyp','$fits',
                '$father','$mother','$siblings','$habits','$allergy','$others','$medication','$historyDate','$appearance','$weight','$height','$bmi','$systolic',
                '$diastolic','$pulse','$va_aidedr','$va_aidedl','$va_unaidedr','$va_unaidedl','$colour_r','$colour_l','$fundoscopy_r','$fundoscopy_l','$nose','$throat','$neck',
                '$skin','$excanal_r','$excanal_l','$eardrum_r','$eardrum_l','$discharged_r','$discharged_l','$sound','$murmur','$airentry','$chestexp','$breathsound','$liver',
                '$spleen','$kidney','$mentalfunct','$coordination','$gait','$genitalia','$rectal','$lpow_r','$lpow_l','$lref_r','$lref_l','$lsen_r','$lsen_l',
                '$upow_r','$upow_l','$uref_r','$uref_l','$usen_r','$usen_l','$breast','$lmp','$gynaecology','$lastps','$cxr','$ecg','$mammogram',
                '$us_breast','$us_abdopel','$stresstest','$pta','$lft','$urine','$blood','$impression','$recommendation','$date','$doneBy','$visits','$package',
                '$addons','$ic')";
