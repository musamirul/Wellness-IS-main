...
<html>
    ...
    <body>
        ...
        <?php
            ...
            <?php
                $query3 = "UPDATE record SET nose='$nose',throat='$throat',neck='$neck',
                skin='$skin',excanal_r='$excanal_r', excanal_l='$excanal_l',eardrum_r='$eardrum_r',
                eardrum_l='$eardrum_l',discharged_r='$discharged_r', discharged_l='$discharged_l',
                sound='$sound',murmur='$murmur',airentry='$airentry',chestexp='$chestexp',
                breathsound='$breathsound',liver='$liver',spleen='$spleen',kidney='$kidney',
                mentalfunct='$mentalfunct', coordination='$coordination',gait='$gait',
                genitalia='$genitalia',rectal='$rectal',lpow_r='$lpow_r',lpow_l='$lpow_l',
                lref_r='$lref_r',lref_l='$lref_l',lsen_r='$lsen_r',lsen_l='$lsen_l',
                upow_r='$upow_r',upow_l='$upow_l',uref_r='$uref_r',uref_l='$uref_l',
                usen_r='$usen_r', usen_l='$usen_l',breast='$breast',lmp='$lmp',
                gynaecology='$gynaecology',lastps='$lastps', cxr='$cxr',ecg='$ecg',
                mammogram='$mammogram',us_breast='$us_breast',us_abdopel='$us_abdopel',
                stresstest='$stresstest',pta='$pta',lft='$lft',urine='$urine',
                blood='$blood',impression='$impression',recommendation='$recommendation',
                doneBy='$doneBy' WHERE recordID ='$recordID'";
