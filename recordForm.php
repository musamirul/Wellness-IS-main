        ...
        <?php
			...
			<br>
				...
				<?php
                    ...
                    if ($row['package'] == "Comprehensive" || $row['package'] == "Premium" || $row['package'] == "Custom"|| $row['package'] == "Essential" || $row['package']=="Preemployment" || $row['package']=="Pre")
					{ 
                ?>
							...
							<input type="text" id="blood" name="blood" required><br><br><br>
                            <div class="row">
                                <div class="textfield">
                        
                                    <label class="inline" for="impression">Impression:</label>
                                    <textarea id="impression" name="impression" rows="5" cols="100" required></textarea>
                                </div>
                            </div>
							<div class="row">
                                <div class="textfield">
                                    <label class="inline" for="recommendation">Recommendation: </label>
                                    <textarea id="recommendation" name="recommendation" rows="5" cols="100" required></textarea>
                                </div>
                            </div>
                ...
                <form method="post">
                    <p>
                        Physical Examination incomplete, complete <button formaction="physicalExam.php" class="unstyled-button">here</button>
                    </p>
                        <input type="hidden" name="mrn" value="<?php echo $mrn;?>">
                        <input type="hidden" name="ic" value="<?php echo $ic; ?>">
