...
<html>
    ...
    <body>
        <?php
            ...
            $query = "SELECT ic_passport FROM patient WHERE mrn = '$mrn'";
        ...
        <div class="container" style=" height: 250px;">
            ...
            ?>
                        <div class="text-center">
                            ...
                            <form method="post" style="text-align: center;" class="btn-group">
                                ...
                                <input type="hidden" name="ic" value="<?php echo $row['ic_passport']; ?>">
            ...
            <table style="width: 100%;" class="table table-striped">
                ...
                <?php
                    ...
                    /*$query1 = "SELECT a.mrn, name, ic_passport, addonsUsed, 
                    lastUpdate, packageUsed, visits  FROM patient a, record b 
                    WHERE a.mrn = '$mrn' AND b.mrn = '$mrn' ORDER BY lastUpdate 
                    DESC LIMIT ". $start_from. ", " .$per_page_record;*/

                    $query1 = "SELECT patient.mrn, patient.name, patient.ic_passport,
                    record.recordID, record.mrn, record.lastUpdate, record.visits, record.packageUsed, record.addonsUsed
                    FROM patient
                    INNER JOIN record
                    ON patient.ic_passport = record.fk_patient_ic WHERE patient.ic_passport = '$ic'
                    ";
                            ...
                            <div class="d-flex flex-row-reverse">
                                <div class="p-2">
                                    <form method="post">
                                        ...
                                        <input type="hidden" name="ic" value="<?php echo $row['ic_passport'] ?>">
                                        <button formaction="editScreening.php" class="btn btn-primary">Edit Screening</button>
                                    </form>
                                </div>
                                <div class="p-2">
                                    <form method="post">
