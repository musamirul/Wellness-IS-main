                ...
                <div id="printable">
                        ...
                        <div class="ms-4 me-1">        
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <img src="logo.png" width="200px" height="60px" class="rounded mx-auto d-block">
                                </div>
                                <div class="col-4 ">
                                    <div class="d-flex flex-row">
                                        <div class="fs-8">MRN :</div>
                                        <div class="fs-6 fw-semibold"><?php echo $row["mrn"];?></div>
                                    </div>
                                    <div class="d-flex flex-row">
                                        <div class="">Date :</div>
                                        <div class="">NULL</div>
                                    ...
                                    <div class="d-flex flex-row">
                                        <div class="">Tel H/P :</div>
                                        <div class=""><?php echo $row["telephone"];?></div>
                                    </div>
                                </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    : <span id="name"><?php echo $row["name"];?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-2">
                                    <div class="d-flex flex-column bd-highlight">
                                        <div class="bd-highlight"><label for="icpp" class="">IC/Passport</label></div>
                                        <div class="bd-highlight"><label for="dob" class="">DOB</label></div>
                                        <div class="bd-highlight"><label for="address" class="">Address</label></div>
                                        <div class="bd-highlight"><label for="email" class="">Email</label></div>
                                        <div class="bd-highlight"><label for="packageUsed" class="">Package</label></div>
                                        <div class="bd-highlight"><label for="addons" class="">Additional Test</label></div>
                                        
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex flex-column bd-highlight">
                                        <div class="bd-highlight">: <span id="icpp"><?php echo $row["ic_passport"];?></span></div>
                                        <div class="bd-highlight">: <span id="dob"><?php echo $row["date_of_birth"];?></span></div>
                                        <div class="bd-highlight">:<span id="address" style="display"> <?php echo $row["address"];?></span></div>
                                        <div class="bd-highlight">: <span id="email"><?php echo $row["email"];?></span></div>
                                        <div class="bd-highlight">: <span id="packageUsed"><?php echo $row["packageUsed"];?></span></div>
                                        <div class="bd-highlight">: <span id="addons" style="display: inline-block"><?php echo nl2br($row["addons"]);?></span></div>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="d-flex flex-column bd-highlight">
                                        <div class="bd-highlight"><label for="sex" class="">Sex</label></div>
                                        <div class="bd-highlight"><label for="occupation" class="">Occupation</label></div>
                                        <div class="bd-highlight"><label for="race" class="">Race</label></div>
                                        <div class="bd-highlight"><label for="religion" class="">Religion</label></div>
                                        <div class="bd-highlight"><label for="mstatus" class="">Marital Status</label></div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex flex-column bd-highlight">
                                        <div class="bd-highlight">: <span id="sex"><?php echo $row["sex"];?></span></div>
                                        <div class="bd-highlight">: <span id="occupation"><?php echo $row["occupation"];?></span></div>
                                        <div class="bd-highlight">: <span id="race"><?php echo $row["race"];?></span></div>
                                        <div class="bd-highlight">: <span id="religion"><?php echo $row["religion"];?></span></div>
                                        <div class="bd-highlight">: <span id="mstatus"><?php echo $row["marital_status"];?></span></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col float-end bg-primary">test</div>
